<template>
    ...
    <div class="flex-grow overflow-auto">
            ...
            <tr v-for="(item, index) in steels">
                ...
                <td :class='["px-2 py-1.5 text-center", index%2 === 0 ? "" : "bg-gray-300"]'>
                    ...
                    <div v-if="!this.hideUpdate && item.id === this.updId" class="flex justify-center">
                        <svg @click.prevent="updateProject('steel')" xmlns="http://www.w3.org/2000/svg" fill="none"
        ...
        <StoreComponent :hide-material="this.hideMaterial" :element="'steel'" :element-title="'марки стали'"
                        @closeStore="closeStore"></StoreComponent>
        <DeleteComponent :del-element="this.delElement" :hide-delete="this.hideDelete" :del-title="'steel'"
