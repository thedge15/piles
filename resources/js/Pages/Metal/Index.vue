                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-4 bg-lime-50">
                    <div class="table-wrp block max-h-96">
                        <table v-if="metals" class="w-full text-sm text-left text-blue-100 dark:text-blue-100">
                            ...
                            <tbody>
                            <tr v-for="metal in metals.data" class="bg-blue-500 border-b border-blue-400">
                                <td class="px-6">
                                    {{ metal.id }}
                                </td>
                                ...
                                <td class="px-6 text-center">
                                    <Link :href="route('specification.show.metal', metal.id)">
                                ...
                                <td class="px-6 text-center">
                                    <Link :href="route('specification.show.standard', metal.id)">
                                        <svg
